...
Task
0. Install a redis instance File: dump.rdb
...
Install node_redis using npm - References
...
^C
bob@dylan:~$
5. Node Redis client publisher and subscriber File: 5-subscriber.js - 5-publisher.js
